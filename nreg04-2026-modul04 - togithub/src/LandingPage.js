  ...
  return (
    <View style={styles.centerContainer}>
      <View style={styles.header}>
        <Image 
          // Pastikan file brand.png ada di folder assets
...
const styles = StyleSheet.create({
  ...
  mainImage: { width: 120, height: 120, marginBottom: 20 },
  welcomeText: { fontSize: 28, fontWeight: '800', color: '#0F172A' },
  versionText: { color: '#0EA5E9', fontSize: 14 },
  description: { fontSize: 16, color: '#64748B', marginTop: 5 },
  profileCard: {
    backgroundColor: '#FFFFFF', width: '100%', padding: 20,
    borderRadius: 24, elevation: 5, borderWidth: 1, borderColor: '#F1F5F9',
  },
  label: { fontSize: 10, fontWeight: 'bold', color: '#94A3B8', marginBottom: 15 },
  ...
  prodiTag: { fontSize: 12, color: '#0EA5E9', fontWeight: '600', marginTop: 4 },
});